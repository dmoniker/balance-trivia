...
const questions = [
  ...
  {
    question:
      "Which country is known for its famous carnival in Rio de Janeiro?",
  ...
  {
    question:
      "Which river is considered the birthplace of ancient Indian civilization?",
    options: [
      "Ganges River",
      "Indus River",
      "Brahmaputra River",
  ...
  {
    question:
      "Which country is known for its stunning landscapes and Lord of the Rings films?",
  ...
  {
    question:
      "Which European country is known for its delicious pastries and windmills?",
  ...
  {
    question:
      "Which country is known for its delicious Swiss cheese and watches?",
  ...
  {
    question:
      "Which country is known for its stunning landscapes and kiwi fruit?",
    options: ["Australia", "New Zealand", "Fiji", "Samoa"],
    answer: "New Zealand",
    category: "geography",
    difficulty: "easy",
  ...
  {
    question:
      "Which country is known for its famous tulip fields and windmills?",
  ...
  {
    question:
      "Which country is known for its delicious pastries and chocolates?",
    options: ["Switzerland", "Belgium", "France", "Austria"],
    answer: "Belgium",
    category: "geography",
    difficulty: "easy",
  ...
  {
    question:
      "Which African country is known for its wildlife and Victoria Falls?",
  ...
  {
    question:
      "Which country is known for its stunning landscapes and kangaroos?",
    options: ["New Zealand", "Australia", "Fiji", "Papua New Guinea"],
    answer: "Australia",
    category: "geography",
    difficulty: "easy",
  ...
  {
    question:
      "Which US President authorized the dropping of atomic bombs on Hiroshima and Nagasaki?",
    options: [
      "Dwight D. Eisenhower",
      "Harry S. Truman",
      "John F. Kennedy",
  ...
  {
    question:
      "Which athlete won the most gold medals in a single Olympic Games?",
  ...
  {
    question:
      "Which tennis player has the most Grand Slam titles in the Open Era?",
    options: [
      "Roger Federer",
      "Rafael Nadal",
      "Novak Djokovic",
  ...
  {
    question:
      "Which US President served as a movie actor before entering politics?",
    options: [
      "Ronald Reagan",
      "John F. Kennedy",
      "Richard Nixon",
  ...
  {
    question:
      "Who holds the record for the most goals scored in international soccer matches?",
  ...
  {
    question:
      "Who won the gold medal in the men's 100-meter sprint at the 2016 Olympics?",
  ...
  {
    question:
      "Who is the only athlete to win Olympic gold in both the 100-meter and 200-meter sprints in three consecutive Olympics?",
    options: [
      "Usain Bolt",
      "Carl Lewis",
      "Jesse Owens",
  ...
  {
    question:
      "Which boxer held the world heavyweight title for a record 12 years and six months?",
  ...
  {
    question:
      "Who is credited with the discovery of the first antibiotic, streptomycin?",
    options: [
      "Alexander Fleming",
      "Howard Florey",
      "Ernst Chain",
  ...
  {
    question:
      "Who discovered the principles of heredity through experiments with pea plants?",
    options: [
      "Gregor Mendel",
      "Thomas Hunt Morgan",
      "Hugo de Vries",
  ...
  {
    question:
      "Which city hosted the 1968 Summer Olympics, remembered for the Black Power salute?",
  ...
  {
    question:
      "Which novel features a character named Big Brother and popularized the phrase 'Big Brother is watching you'?",
  ...
  {
    question:
      "In which play by William Shakespeare does the character Portia appear?",
    options: [
  ...
  {
    question:
      "Which novel by Jules Verne tells the story of Captain Nemo and his submarine?",
    options: [
  ...
  {
    question:
      "What is the name of the fictional school of magic in J.K. Rowling's 'Harry Potter' series?",
  ...
  {
    question:
      "What is the title of the children's book series by C.S. Lewis featuring a magical wardrobe?",
    options: [
  ...
  {
    question:
      "In 'The Chronicles of Narnia' by C.S. Lewis, what type of animal is Aslan?",
  ...
  {
    question:
      "What is the name of the protagonist in Charlotte Brontë's novel 'Jane Eyre'?",
    options: [
      "Jane Eyre",
      "Elizabeth Bennet",
      "Emma Woodhouse",
  ...
  {
    question:
      "Which novel by Charles Dickens follows the life of Pip, an orphan boy?",
    options: [
      "Great Expectations",
      "Oliver Twist",
  ...
  {
    question:
      "Which science fiction novel by Ray Bradbury depicts a dystopian society where books are banned?",
    options: [
      "Fahrenheit 451",
      "Brave New World",
      "1984",
  ...
  {
    question:
      "What is the title of the play by Arthur Miller about the Salem witch trials?",
    options: [
      "The Crucible",
      "Death of a Salesman",
  ...
  {
    question:
      "Which novel by F. Scott Fitzgerald explores the decadence of the Jazz Age in America?",
    options: [
      "The Great Gatsby",
  ...
  {
    question:
      "What is the name of the magical sword in J.R.R. Tolkien's 'The Lord of the Rings'?",
  ...
  {
    question:
      "In Edgar Allan Poe's poem 'The Raven,' what word does the raven keep repeating?",
  ...
  {
    question:
      "Which novel by Aldous Huxley depicts a future society where people are controlled by drugs and technology?",
  ...
  {
    question:
      "What is the name of the detective in Arthur Conan Doyle's Sherlock Holmes stories?",
  ...
  {
    question:
      "In 'Pride and Prejudice,' what is the name of Mr. Darcy's estate?",
  ...
  {
    question:
      "What is the name of the family in the novel 'Little Women' by Louisa May Alcott?",
  ...
  {
    question:
      "In Ernest Hemingway's 'The Old Man and the Sea,' what type of fish does the old man catch?",
  ...
  {
    question:
      "Which novel by George Orwell depicts a totalitarian regime ruled by a pig named Napoleon?",
  ...
  {
    question:
      "In which play by Oscar Wilde does the character Lady Bracknell famously say, 'A handbag?'",
    options: [
  ...
  {
    question:
      "What is the title of the poem by Robert Frost that begins with the line, 'Two roads diverged in a yellow wood'?",
    options: [
      "The Road Not Taken",
  ...
  {
    question:
      "Which novel by Margaret Atwood takes place in a dystopian society called Gilead?",
    options: [
      "The Handmaid's Tale",
      "Brave New World",
      "1984",
  ...
  {
    question:
      "In Jules Verne's 'Around the World in Eighty Days,' what is the name of the main character?",
  ...
  {
    question:
      "What is the title of the novel by Joseph Heller that satirizes war and bureaucracy?",
    options: [
      "Catch-22",
      "Slaughterhouse-Five",
      "A Farewell to Arms",
  ...
  {
    question:
      "In Shakespeare's 'A Midsummer Night's Dream,' who is the king of the fairies?",
  ...
  {
    question:
      "Which novel by Jack Kerouac follows a group of friends as they travel across the United States?",
    options: [
      "On the Road",
      "The Great Gatsby",
      "The Catcher in the Rye",
  ...
  {
    question:
      "What is the name of the ancient epic poem attributed to Homer that tells the story of the Trojan War?",
    options: [
      "The Iliad",
      "The Odyssey",
      "The Aeneid",
  ...
  {
    question:
      "In Gabriel García Márquez's 'One Hundred Years of Solitude,' what is the name of the fictional town?",
  ...
  {
    question:
      "What is the name of the island in William Golding's 'Lord of the Flies' where the boys are stranded?",
    options: [
      "Unnamed Island",
      "Coral Island",
      "Treasure Island",
  ...
  {
    question:
      "In John Steinbeck's 'Of Mice and Men,' what is the name of the mentally disabled character?",
  ...
  {
    question:
      "What is the title of the play by Samuel Beckett that features two characters waiting for someone who never arrives?",
    options: [
      "Waiting for Godot",
  ...
  {
    question:
      "Which novel by Jane Austen follows the life of Emma Woodhouse and her attempts at matchmaking?",
    options: [
      "Emma",
  ...
  {
    question:
      "In the novel 'The Catcher in the Rye,' what is the name of the protagonist's younger sister?",
  ...
  {
    question:
      "What is the title of the children's book series by Roald Dahl about a young boy named Charlie?",
    options: [
  ...
  {
    question:
      "In the play 'Death of a Salesman' by Arthur Miller, what is the name of the main character?",
  ...
  {
    question:
      "Which novel by Virginia Woolf follows a group of characters over the course of a single day?",
    options: [
      "Mrs. Dalloway",
      "To the Lighthouse",
      "Orlando",
  ...
  {
    question:
      "What is the name of the boarding school in J.D. Salinger's 'The Catcher in the Rye'?",
    options: [
      "Pencey Prep",
      "Hogwarts",
      "Wellington Academy",
  ...
  {
    question:
      "In George Orwell's '1984,' what is the name of the government's propaganda department?",
    options: [
      "Ministry of Truth",
      "Ministry of Love",
      "Ministry of Peace",
  ...
  {
    question:
      "Which novel by Jane Austen features the character Elizabeth Bennet and her four sisters?",
    options: [
      "Pride and Prejudice",
      "Emma",
      "Sense and Sensibility",
  ...
  {
    question:
      "What is the name of the theater where Romeo and Juliet first meet in Shakespeare's play?",
    options: [
      "The Capulet's Ballroom",
      "The Globe Theatre",
      "The Verona Theater",
      "The Montague's Mansion",
    ],
  ...
  {
    question:
      "In 'The Picture of Dorian Gray' by Oscar Wilde, what happens to the portrait of Dorian Gray?",
    options: [
      "It ages and shows the effects of his sins",
      "It remains forever youthful while Dorian himself ages",
      "It is destroyed and the curse is lifted",
      "It becomes the subject of a famous art exhibition",
    ],
  ...
  {
    question:
      "What is the title of the play by Tennessee Williams about a woman named Blanche DuBois?",
    options: [
      "A Streetcar Named Desire",
  ...
  {
    question:
      "In George Orwell's 'Animal Farm,' what is the name of the pig who becomes the totalitarian leader?",
  ...
  {
    question:
      "Which novel by Emily Brontë features the characters Heathcliff and Catherine Earnshaw?",
    options: [
      "Wuthering Heights",
      "Pride and Prejudice",
      "Jane Eyre",
  ...
  {
    question:
      "What is the name of the street where Sherlock Holmes and Dr. Watson live in London?",
  ...
  {
    question:
      "In Bram Stoker's 'Dracula,' what is the name of the ship that brings Dracula to England?",
  ...
  {
    question:
      "Which novel by J.R.R. Tolkien follows the journey of Frodo Baggins to destroy the One Ring?",
    options: [
  ...
  {
    question:
      "In the novel 'The Scarlet Letter' by Nathaniel Hawthorne, what is the symbol on Hester Prynne's chest?",
  ...
  {
    question:
      "Which play by William Shakespeare features the characters Rosencrantz and Guildenstern?",
    options: ["Hamlet", "Macbeth", "Romeo and Juliet", "Othello"],
    answer: "Hamlet",
    category: "arts and literature",
    difficulty: "hard",
  ...
  {
    question:
      "What is the name of the city in which Fyodor Dostoevsky's 'Crime and Punishment' takes place?",
  ...
  {
    question:
      "In 'Sense and Sensibility' by Jane Austen, which sister is known for her sense, and which one for her sensibility?",
    options: [
      "Elinor for sense, Marianne for sensibility",
      "Marianne for sense, Elinor for sensibility",
      "Jane for sense, Elizabeth for sensibility",
      "Elizabeth for sense, Jane for sensibility",
    ],
  ...
  {
    question:
      "What is the title of the novel by Leo Tolstoy that tells the story of Russian society during the Napoleonic era?",
    options: [
      "War and Peace",
      "Anna Karenina",
  ...
  {
    question:
      "In George Orwell's 'Animal Farm,' what is the name of the horse who represents the working class?",
  ...
  {
    question:
      "Which novel by Charles Dickens features the character Sydney Carton and his famous last words, 'It is a far, far better thing that I do'?",
    options: [
      "A Tale of Two Cities",
      "Great Expectations",
      "Oliver Twist",
  ...
  {
    question:
      "What is the name of the fictional town where Harper Lee's 'To Kill a Mockingbird' is set?",
    options: ["Maycomb", "Starkville", "Bedford Falls", "Hill Valley"],
    answer: "Maycomb",
    category: "arts and literature",
    difficulty: "hard",
  ...
  {
    question:
      "In the novel 'Oliver Twist' by Charles Dickens, what is the name of the workhouse where Oliver is born?",
  ...
  {
    question:
      "What is the title of the novel by Alexandre Dumas about a young man seeking revenge?",
    options: [
  ...
  {
    question:
      "In F. Scott Fitzgerald's 'The Great Gatsby,' what is the name of the lavish mansion owned by the title character?",
  ...
  {
    question:
      "What is the name of the mythical island in Homer's 'The Odyssey' where Odysseus encounters the Cyclops?",
  ...
  {
    question:
      "Which novel by Ernest Hemingway tells the story of an American expatriate in Paris during the 1920s?",
    options: [
      "The Sun Also Rises",
      "For Whom the Bell Tolls",
      "A Farewell to Arms",
  ...
  {
    question:
      "In the novel 'The Adventures of Tom Sawyer' by Mark Twain, what is the name of Tom's love interest?",
    options: [
      "Becky Thatcher",
      "Huckleberry Finn",
      "Amy Lawrence",
  ...
  {
    question:
      "What is the title of the play by Tennessee Williams about a family in the Deep South?",
    options: [
      "The Glass Menagerie",
      "Cat on a Hot Tin Roof",
      "A Streetcar Named Desire",
  ...
  {
    question:
      "In William Shakespeare's 'Macbeth,' what is the name of Macbeth's wife?",
  ...
  {
    question:
      "Which novel by Jane Austen features the character Elinor Dashwood and her sister Marianne?",
    options: [
      "Sense and Sensibility",
      "Pride and Prejudice",
      "Emma",
  ...
  {
    question:
      "In the novel 'Alice's Adventures in Wonderland' by Lewis Carroll, what is the name of the Queen of Hearts' husband?",
    options: [
      "The King of Hearts",
      "The White Rabbit",
      "The Mad Hatter",
  ...
  {
    question:
      "Which play by Arthur Miller features the character Willy Loman, a traveling salesman?",
    options: [
      "Death of a Salesman",
      "The Crucible",
      "All My Sons",
  ...
  {
    question:
      "What is the title of the play by Samuel Beckett in which the characters Vladimir and Estragon wait for someone named Godot?",
    options: [
      "Waiting for Godot",
      "Endgame",
      "Krapp's Last Tape",
  ...
  {
    question:
      "In 'The Adventures of Huckleberry Finn' by Mark Twain, what is the name of Huck's friend and runaway slave?",
  ...
  {
    question:
      "What is the name of the fictional city in 'A Clockwork Orange' by Anthony Burgess?",
  ...
  {
    question:
      "In William Shakespeare's 'Romeo and Juliet,' what is the name of Romeo's cousin and friend?",
  ...
  {
    question:
      "What is the title of the novel by Fyodor Dostoevsky about a man who commits a double murder?",
    options: [
      "Crime and Punishment",
      "The Brothers Karamazov",
  ...
  {
    question:
      "Which novel by George Orwell depicts a dystopian society where individuality is suppressed?",
    options: [
  ...
  {
    question:
      "What is the name of the fictional town where 'Moby-Dick' by Herman Melville is set?",
  ...
  {
    question:
      "In Edgar Allan Poe's poem 'The Raven,' what does the raven perch upon?",
    options: [
      "A bust of Pallas",
      "A chamber door",
      "A midnight dreary",
  ...
  {
    question:
      "What is the title of the play by William Shakespeare about a Moorish general who is driven to jealousy?",
  ...
  {
    question:
      "Which novel by Leo Tolstoy explores the moral dilemmas of Anna Karenina, a married woman in an adulterous affair?",
    options: [
      "Anna Karenina",
      "War and Peace",
      "Crime and Punishment",
  ...
  {
    question:
      "In 'A Midsummer Night's Dream' by William Shakespeare, what is the name of the fairy king?",
    options: ["Oberon", "Titania", "Puck", "Robin Goodfellow"],
    answer: "Oberon",
    category: "arts and literature",
    difficulty: "hard",
  ...
  {
    question:
      "What is the name of the protagonist in Franz Kafka's novella 'The Metamorphosis' who wakes up as a giant insect?",
  ...
  {
    question:
      "What is the title of the novel by Alexandre Dumas about a young man who joins the French Revolution?",
    options: [
      "The Count of Monte Cristo",
      "Les Misérables",
      "The Three Musketeers",
  ...
  {
    question:
      "In George Orwell's '1984,' what is the name of the fictional language created by the government?",
  ...
  {
    question:
      "Which novel by J.D. Salinger follows the story of a teenager named Holden Caulfield?",
    options: [
      "The Catcher in the Rye",
      "To Kill a Mockingbird",
      "The Great Gatsby",
  ...
  {
    question:
      "What is the name of the fictional island in William Golding's 'Lord of the Flies'?",
  ...
  {
    question:
      "In the novel 'To the Lighthouse' by Virginia Woolf, what is the name of the lighthouse?",
    options: [
      "The Godrevy Lighthouse",
      "The Beachy Head Lighthouse",
      "The Cape Hatteras Lighthouse",
      "The Dover Castle Lighthouse",
    ],
  ...
  {
    question:
      "What is the title of the novel by Margaret Atwood that takes place in a dystopian future where women are oppressed?",
    options: [
      "The Handmaid's Tale",
      "Brave New World",
      "1984",
  ...
  {
    question:
      "Which cuisine is known for its use of spices such as cumin, coriander, and turmeric?",
    options: [
      "Indian cuisine",
      "Thai cuisine",
      "Chinese cuisine",
  ...
  {
    question:
      "Which cuisine is famous for its use of coconut milk and spices like lemongrass and galangal?",
    options: [
      "Thai cuisine",
      "Indian cuisine",
      "Indonesian cuisine",
  ...
  {
    question:
      "What is the main ingredient in a traditional British fish and chips dish?",
  ...
  {
    question:
      "Which cuisine is known for its emphasis on fresh seafood and sushi?",
    options: [
  ...
  {
    question:
      "Which cuisine is known for its use of pickled vegetables, rice vinegar, and soy sauce?",
    options: [
      "Chinese cuisine",
      "Japanese cuisine",
      "Korean cuisine",
  ...
  {
    question:
      "Which cuisine is known for its use of spices such as cinnamon, cloves, and saffron?",
    options: [
      "Indian cuisine",
      "Italian cuisine",
      "Spanish cuisine",
  ...
  {
    question:
      "Which country is famous for its traditional butter chicken dish?",
  ...
  {
    question:
      "Which cuisine is known for its use of flavors like lime, cilantro, and chili peppers?",
    options: [
      "Mexican cuisine",
      "Thai cuisine",
      "Vietnamese cuisine",
  ...
  {
    question:
      "Which cuisine is known for its use of garlic, olive oil, and tomatoes?",
    options: [
      "Italian cuisine",
      "Greek cuisine",
      "Spanish cuisine",
  ...
  {
    question:
      "Which cuisine is known for its use of flavors like tamarind, turmeric, and cardamom?",
    options: [
      "Indian cuisine",
      "Thai cuisine",
      "Malaysian cuisine",
  ...
  {
    question:
      "Which cuisine is known for its use of flavors like soy sauce, ginger, and garlic?",
    options: [
      "Chinese cuisine",
      "Japanese cuisine",
      "Korean cuisine",
  ...
  {
    question:
      "What is the key ingredient in a traditional Ethiopian injera bread?",
  ...
  {
    question:
      "Which cuisine is known for its use of flavors like sumac, pomegranate, and mint?",
    options: [
      "Lebanese cuisine",
      "Iranian cuisine",
      "Turkish cuisine",
  ...
  {
    question:
      "What is the main ingredient in a traditional Lebanese tabbouleh salad?",
  ...
  {
    question:
      "Which country is famous for its traditional beef Wellington dish?",
  ...
  {
    question:
      "Which cuisine is known for its use of flavors like coconut milk, lime leaves, and chili paste?",
    options: [
      "Thai cuisine",
      "Vietnamese cuisine",
      "Indonesian cuisine",
  ...
  {
    question:
      "What is the key ingredient in a traditional French escargot dish?",
  ...
  {
    question:
      "Which cuisine is known for its use of flavors like paprika, caraway seeds, and sauerkraut?",
    options: [
      "French cuisine",
      "Italian cuisine",
      "German cuisine",
  ...
  {
    question:
      "What is the main ingredient in a traditional Korean bibimbap dish?",
  ...
  {
    question:
      "What is the key ingredient in a traditional Italian tiramisu dessert?",
  ...
  {
    question:
      "What is the main ingredient in a traditional German sauerkraut dish?",
  ...
  {
    question:
      "Which cuisine is known for its use of flavors like lemongrass, fish sauce, and chili peppers?",
    options: [
      "Vietnamese cuisine",
      "Thai cuisine",
      "Indonesian cuisine",
  ...
  {
    question:
      "Which cuisine is known for its use of flavors like lime, avocado, and cilantro?",
    options: [
      "Mexican cuisine",
      "Peruvian cuisine",
      "Cuban cuisine",
  ...
  {
    question:
      "What is the main ingredient in a traditional Japanese tempura dish?",
  ...
  {
    question:
      "Which country is famous for its traditional beef stroganoff dish?",
  ...
  {
    question:
      "Which cuisine is known for its use of flavors like thyme, rosemary, and lavender?",
    options: [
      "French cuisine",
      "Italian cuisine",
      "Greek cuisine",
  ...
  {
    question:
      "Which country is famous for its traditional tandoori chicken dish?",
  ...
  {
    question:
      "What is the main ingredient in a traditional Jamaican jerk chicken dish?",
  ...
  {
    question:
      "Which country is famous for its traditional Wiener Schnitzel dish?",
  ...
  {
    question:
      "Which cuisine is known for its use of flavors like oregano, feta cheese, and olives?",
    options: [
      "Greek cuisine",
      "Italian cuisine",
      "Turkish cuisine",
  ...
  {
    question:
      "Which cuisine is known for its use of flavors like saffron, cardamom, and rose water?",
    options: [
      "Indian cuisine",
      "Persian cuisine",
      "Turkish cuisine",
  ...
  {
    question:
      "What is the main ingredient in a traditional Turkish baklava dessert?",
  ...
  {
    question:
      "Which country is famous for its traditional piri piri chicken dish?",
  ...
  {
    question:
      "What is the main ingredient in a classic Mexican enchilada dish?",
  ...
  {
    question:
      "What is the key ingredient in a traditional Italian pesto sauce?",
  ...
  {
    question:
      "Which cuisine is known for its use of flavors like basil, pine nuts, and parmesan cheese?",
    options: [
      "Italian cuisine",
      "French cuisine",
      "Spanish cuisine",
  ...
  {
    question:
      "What is the main ingredient in a traditional Ethiopian doro wat dish?",
  ...
  {
    question:
      "What is the main ingredient in a traditional Brazilian feijoada dish?",
  ...
  {
    question:
      "What is the key ingredient in a traditional Mexican pozole soup?",
  ...
  {
    question:
      "What is the name of the legendary creature that is half-lion and half-eagle?",
  ...
  {
    question:
      "According to Irish folklore, what mythical creature is said to grant wishes?",
  ...
  {
    question:
      "In Chinese mythology, which animal is associated with wisdom and longevity?",
  ...
  {
    question:
      "What mythical creature is said to be a part of Scottish folklore and live in the water?",
  ...
  {
    question:
      "Which legendary hero is known for his archery skills and is associated with Greek mythology?",
  ...
  {
    question:
      "In Native American folklore, what creature is said to have the ability to transform into a wolf?",
  ...
  {
    question:
      "Which ancient civilization believed in the existence of the minotaur?",
  ...
  {
    question:
      "Which creature from Russian folklore is said to be a hybrid of a bird and a woman?",
  ...
  {
    question:
      "According to Norse mythology, what animal pulls the chariot of the moon?",
  ...
  {
    question:
      "Which legendary creature is associated with the Loch Ness in Scotland?",
  ...
  {
    question:
      "In Hindu mythology, who is the monkey god known for his strength and devotion?",
  ...
  {
    question:
      "Which famous figure from Arthurian legends is known as the Lady of the Lake?",
  ...
  {
    question:
      "What creature from Persian mythology is often depicted as a large, winged lion?",
  ...
  {
    question:
      "According to Native American folklore, what creature possesses the power of healing and foresight?",
  ...
  {
    question:
      "Which legendary figure is said to have pulled a sword from a stone, becoming the rightful king of England?",
  ...
  {
    question:
      "In Egyptian mythology, what creature is part lion and part human?",
  ...
  {
    question:
      "What is the name of the legendary sword associated with King Arthur?",
  ...
  {
    question:
      "Which creature from Scottish folklore is said to be a water-dwelling horse?",
  ...
  {
    question:
      "According to Greek mythology, what is the name of the three-headed dog guarding the gates of the underworld?",
  ...
  {
    question:
      "In Native American folklore, what creature is believed to be a protector of nature and the forest?",
  ...
  {
    question:
      "Which creature from Norse mythology has the ability to shape-shift into different animals?",
  ...
  {
    question:
      "In Hindu mythology, what is the name of the god known as the preserver of the universe?",
  ...
  {
    question:
      "According to Japanese folklore, what creature is a half-human and half-fish?",
  ...
  {
    question:
      "Which legendary creature from Irish folklore is said to be mischievous and often depicted as a small, bearded man?",
  ...
  {
    question:
      "In Norse mythology, what is the name of the tree that connects the nine realms?",
  ...
  {
    question:
      "According to Greek mythology, who is the god of wine and celebration?",
  ...
  {
    question:
      "Which creature from Persian mythology is depicted as a giant bird with a wingspan capable of blocking out the sun?",
  ...
  {
    question:
      "In Native American folklore, what creature is associated with trickery and transformation?",
  ...
  {
    question:
      "Which legendary figure from Arthurian legends is known for his role as King Arthur's mentor?",
  ...
  {
    question:
      "In Greek mythology, what creature is said to be a hybrid of a lion and a goat?",
  ...
  {
    question:
      "What is the name of the legendary sword associated with the British king, Excalibur's sister?",
  ...
  {
    question:
      "In Chinese mythology, what creature is said to control the waters and bring rainfall?",
  ...
  {
    question:
      "Which mythical creature from Irish folklore is believed to be a solitary fairy, usually depicted as an old man with a pipe?",
  ...
  {
    question:
      "According to Hindu mythology, what is the name of the goddess of wealth and prosperity?",
  ...
  {
    question:
      "In Greek mythology, what is the name of the winged horse born from the blood of Medusa?",
  ...
  {
    question:
      "Which creature from Scottish folklore is said to be a small, mischievous household spirit?",
  ...
  {
    question:
      "According to Native American folklore, what creature is associated with the spirit world and is considered a messenger?",
  ...
  {
    question:
      "What legendary creature from medieval bestiaries is said to be a serpent with the head of a lion and the wings of a bird?",
  ...
  {
    question:
      "In Norse mythology, what creature is said to cause ships to sink and drown sailors?",
  ...
  {
    question:
      "According to Greek mythology, who is the goddess of wisdom and warfare strategy?",
    options: ["Athena", "Hera", "Aphrodite", "Artemis"],
    answer: "Athena",
    category: "mythology",
    difficulty: "hard",
  ...
  {
    question:
      "Which creature from Chinese mythology is associated with good luck and is often depicted with a horn on its forehead?",
  ...
  {
    question:
      "In Irish folklore, what mythical creature is said to bring bad luck and is often depicted as a female spirit?",
  ...
  {
    question:
      "What is the name of the legendary sword associated with the Celtic hero, Cú Chulainn?",
  ...
  {
    question:
      "According to Hindu mythology, who is the god of knowledge, music, and arts?",
  ...
  {
    question:
      "Which legendary creature from Scandinavian folklore is said to be a female spirit associated with waterways and waterfalls?",
  ...
  {
    question:
      "According to Greek mythology, what creature is said to be a hybrid of a lion, goat, and serpent?",
  ...
  {
    question:
      "What is the name of the legendary sword associated with the knight Roland in French folklore?",
  ...
  {
    question:
      "According to Egyptian mythology, who is the goddess of magic and healing?",
  ...
  {
    question:
      "In Norse mythology, what creature is said to fly through the sky and deliver messages to the gods?",
  ...
  {
    question:
      "According to Irish folklore, what creature is said to guard a pot of gold at the end of a rainbow?",
  ...
  {
    question:
      "In Hindu mythology, what is the name of the god known as the destroyer of evil?",
    options: ["Vishnu", "Shiva", "Brahma", "Indra"],
    answer: "Shiva",
    category: "mythology",
    difficulty: "easy",
  ...
  {
    question:
      "Which mythical creature from Scottish folklore is said to be a small, solitary household spirit?",
  ...
  {
    question:
      "What is the name of the legendary sword associated with the knight Lancelot in Arthurian legends?",
  ...
  {
    question:
      "According to Norse mythology, who is the queen of the gods and wife of Odin?",
  ...
  {
    question:
      "Which creature from Irish folklore is believed to be a malevolent spirit, often depicted as a horse with burning eyes?",
  ...
  {
    question:
      "In Hindu mythology, what is the name of the goddess of love and fertility?",
  ...
  {
    question:
      "What legendary creature from Arabian folklore is said to be a half-lion and half-eagle?",
  ...
  {
    question:
      "In Native American folklore, what creature is believed to be a spirit guide and protector of tribes?",
  ...
  {
    question:
      "Which mythical creature from Persian mythology is said to be a giant, fire-breathing bird?",
  ...
  {
    question:
      "According to Japanese folklore, what type of creature is a tengu?",
  ...
  {
    question:
      "What creature from Scottish folklore is said to be a large, terrifying sea monster?",
  ...
  {
    question:
      "According to Greek mythology, who is the goddess of the hunt and the moon?",
  ...
  {
    question:
      "In Norse mythology, what creature is said to be a giant serpent encircling the world?",
  ...
  {
    question:
      "Which legendary figure from Arthurian legends is known for his role as King Arthur's greatest knight?",
  ...
  {
    question:
      "According to Egyptian mythology, who is the god of the dead and the afterlife?",
  ...
  {
    question:
      "In Irish folklore, what mythical creature is said to be a nocturnal water horse?",
  ...
  {
    question:
      "Which creature from Norse mythology is said to be a squirrel that runs up and down the world tree?",
  ...
  {
    question:
      "According to Greek mythology, what creature is said to be a hybrid of a lion and an eagle?",
  ...
  {
    question:
      "What legendary creature from Celtic folklore is said to be a water horse that lures people to their doom?",
  ...
  {
    question:
      "According to Norse mythology, who is the god of mischief and trickery?",
  ...
  {
    question:
      "In Chinese mythology, what creature is said to guard the heavenly gates and prevent evil spirits from entering?",
  ...
  {
    question:
      "Which creature from Russian folklore is believed to be a mischievous house spirit?",
  ...
  {
    question:
      "According to Irish folklore, what mythical creature is said to be a small, solitary fairy often depicted as an old woman?",
  ...
  {
    question:
      "In Hindu mythology, what is the name of the god known as the supreme being and creator of the universe?",
  ...
  {
    question:
      "According to Greek mythology, who is the goddess of the harvest and fertility?",
  ...
  {
    question:
      "In Egyptian mythology, what creature is depicted as a large, mythical snake?",
  ...
  {
    question:
      "Which legendary creature from Japanese folklore is said to be a giant cat with supernatural powers?",
  ...
  {
    question:
      "What is the name of the first person to swim across the English Channel?",
    options: [
      "Captain Matthew Webb",
      "Gertrude Ederle",
      "Abbe Faria",
      "John William Dalling",
    ],
  ...
  {
    question:
      "What is the name of the world's largest stadium by seating capacity?",
    options: [
      "Wembley Stadium",
      "AT&T Stadium",
  ...
  {
    question:
      'Who played the character Tony Stark in the "Iron Man" film series?',
    options: [
      "Robert Downey Jr.",
      "Chris Evans",
      "Chris Hemsworth",
  ...
  {
    question:
      'What was the name of the fictional town where "The Andy Griffith Show" took place?',
  ...
  {
    question:
      'Who won the Best Actress Oscar for her role in the film "Gone with the Wind"?',
    options: [
      "Vivien Leigh",
      "Audrey Hepburn",
      "Grace Kelly",
  ...
  {
    question:
      "What was the name of the fictional detective created by Agatha Christie?",
  ...
  {
    question:
      'Which actress played the iconic character Carrie Bradshaw in the TV show "Sex and the City"?',
    options: [
  ...
  {
    question:
      'Which actor played the character Michael Corleone in "The Godfather" film series?',
  ...
  {
    question:
      'Who won the Best Actor Oscar for his role in the film "The Godfather"?',
  ...
  {
    question:
      'Which actress starred as Holly Golightly in the film "Breakfast at Tiffany\'s"?',
    options: [
      "Audrey Hepburn",
      "Marilyn Monroe",
      "Grace Kelly",
  ...
  {
    question:
      'Who played the character Hannibal Lecter in the film "The Silence of the Lambs"?',
    options: [
      "Anthony Hopkins",
      "Mads Mikkelsen",
      "Brian Cox",
  ...
  {
    question:
      'Who won the Best Actress Oscar for her role in the film "Casablanca"?',
    options: [
      "Ingrid Bergman",
      "Audrey Hepburn",
      "Vivien Leigh",
  ...
  {
    question:
      'Which actor played the character Rocky Balboa in the "Rocky" film series?',
    options: [
      "Sylvester Stallone",
  ...
  {
    question:
      'What is the name of the fictional planet in the "Star Trek" franchise?',
  ...
  {
    question:
      "What is the name of the fictional detective created by Dashiell Hammett?",
    options: [
      "Sam Spade",
      "Hercule Poirot",
      "Philip Marlowe",
  ...
  {
    question:
      'Who won the Best Actor Oscar for his role in the film "One Flew Over the Cuckoo\'s Nest"?',
  ...
  {
    question:
      "What is the name of the fictional school attended by Hermione Granger?",
    options: [
  ...
  {
    question:
      "What is the name of the fictional detective created by Rex Stout?",
  ...
  {
    question:
      'Who won the Best Actress Oscar for her role in the film "The Sound of Music"?',
    options: [
      "Julie Andrews",
      "Audrey Hepburn",
      "Marilyn Monroe",
  ...
  {
    question:
      'Which actor played the character James T. Kirk in the original "Star Trek" TV series?',
    options: [
      "William Shatner",
      "Patrick Stewart",
      "Leonard Nimoy",
  ...
  {
    question:
      "What is the name of the fictional detective created by Sue Grafton?",
    options: [
      "Kinsey Millhone",
      "Hercule Poirot",
      "Philip Marlowe",
  ...
  {
    question:
      'Who won the Best Actor Oscar for his role in the film "Forrest Gump"?',
  ...
  {
    question:
      'Which actress starred as Princess Leia in the "Star Wars" franchise?',
    options: [
      "Carrie Fisher",
      "Natalie Portman",
      "Daisy Ridley",
  ...
  {
    question:
      'Who played the character Clarice Starling in the film "The Silence of the Lambs"?',
    options: [
      "Jodie Foster",
      "Julianne Moore",
      "Michelle Pfeiffer",
  ...
  {
    question:
      "Which actor played the character Indiana Jones in the film series?",
  ...
  {
    question:
      "What is the name of the fictional detective created by P. D. James?",
    options: [
      "Adam Dalgliesh",
      "Hercule Poirot",
      "Philip Marlowe",
  ...
  {
    question:
      'Who won the Best Actress Oscar for her role in the film "Million Dollar Baby"?',
    options: [
      "Hilary Swank",
      "Kate Winslet",
      "Cate Blanchett",
  ...
  {
    question:
      'Who won the Best Actor Oscar for his role in the film "Gladiator"?',
    options: [
      "Russell Crowe",
      "Leonardo DiCaprio",
      "Tom Hanks",
  ...
  {
    question:
      "What was the first feature-length animated film produced by Pixar?",
  ...
  {
    question:
      "What is the name of the fictional detective created by Mickey Spillane?",
  ...
  {
    question:
      'Which actor played the character John McClane in the "Die Hard" film series?',
    options: [
      "Bruce Willis",
      "Sylvester Stallone",
      "Arnold Schwarzenegger",
  ...
  {
    question:
      'Who won the Best Actor Oscar for his role in the film "The Departed"?',
    options: [
      "Leonardo DiCaprio",
      "Tom Hanks",
      "Russell Crowe",
  ...
  {
    question:
      'Which actress starred as Belle in the film "Beauty and the Beast"?',
    options: [
      "Emma Watson",
      "Anne Hathaway",
      "Keira Knightley",
  ...
  {
    question:
      'Which actor played the character Ethan Hunt in the "Mission: Impossible" film series?',
  ...
  {
    question:
      'Who won the Best Actress Oscar for her role in the film "The Deer Hunter"?',
    options: [
      "Meryl Streep",
      "Julie Andrews",
      "Audrey Hepburn",
  ...
  {
    question:
      'Which actor starred as Luke Skywalker in the "Star Wars" franchise?',
    options: [
      "Mark Hamill",
      "Harrison Ford",
      "Carrie Fisher",
  ...
  {
    question:
      "What was the first feature-length stop-motion animated film ever released?",
    options: [
  ...
  {
    question:
      'Who won the Best Actress Oscar for her role in the film "The Iron Lady"?',
    options: [
      "Meryl Streep",
      "Kate Winslet",
      "Cate Blanchett",
  ...
  {
    question:
      'What is the name of the fictional planet in the "Star Wars" franchise?',
  ...
  {
    question:
      "What is the name of the fictional detective created by Robert B. Parker?",
  ...
  {
    question:
      'Who won the Best Actor Oscar for his role in the film "American Beauty"?',
  ...
  {
    question:
      "Which actor played the character Spider-Man in the original film series?",
    options: [
      "Tobey Maguire",
      "Andrew Garfield",
      "Tom Holland",
  ...
  {
    question:
      "What is the highest-grossing animated film of the 2020s (so far)?",
    options: [
      "Frozen II",
      "The Lion King",
      "Toy Story 4",
  ...
  {
    question:
      'Who won the Best Actress Oscar for her role in the film "The Reader"?',
    options: [
      "Kate Winslet",
      "Meryl Streep",
      "Julianne Moore",
  ...
  {
    question:
      'Who directed the film "The Lord of the Rings: The Return of the King"?',
    options: [
      "Peter Jackson",
      "Guillermo del Toro",
      "Steven Spielberg",
  ...
  {
    question:
      "What is the name of the fictional detective created by John D. MacDonald?",
  ...
  {
    question:
      'Who won the Best Actor Oscar for his role in the film "There Will Be Blood"?',
    options: [
      "Daniel Day-Lewis",
      "Joaquin Phoenix",
      "Leonardo DiCaprio",
  ...
  {
    question:
      'Who won the Best Actress Oscar for her role in the film "The Blind Side"?',
    options: [
      "Sandra Bullock",
      "Meryl Streep",
      "Julianne Moore",
  ...
  {
    question:
      'Which actor starred as Harry Potter in the "Harry Potter" film series?',
  ...
  {
    question:
      'Who won the Best Actor Oscar for his role in the film "The Pianist"?',
  ...
  {
    question:
      "What was the first feature-length film to be released in IMAX format?",
  ...
  {
    question:
      'Who won the Best Actress Oscar for her role in the film "Silver Linings Playbook"?',
    options: [
      "Jennifer Lawrence",
      "Meryl Streep",
      "Cate Blanchett",
  ...
  {
    question:
      'Who won the Best Actor Oscar for his role in the film "Mystic River"?',
  ...
  {
    question:
      'Who won the Best Actress Oscar for her role in the film "Black Swan"?',
    options: [
      "Natalie Portman",
      "Meryl Streep",
      "Cate Blanchett",
  ...
  {
    question:
      'Who directed the film "The Lord of the Rings: The Fellowship of the Ring"?',
    options: [
      "Peter Jackson",
      "Steven Spielberg",
      "Christopher Nolan",
  ...
  {
    question:
      'Which iconic rock \'n\' roll band, fronted by Mick Jagger, is known for hits like "Satisfaction" and "Paint It Black"?',
  ...
  {
    question:
      'Who was known as the "King of Rock and Roll" and recorded songs like "Hound Dog" and "Jailhouse Rock"?',
    options: [
      "Elvis Presley",
      "Chuck Berry",
      "Jerry Lee Lewis",
  ...
  {
    question:
      '"Yesterday," "Let It Be," and "Hey Jude" are classic hits by which legendary British band?',
  ...
  {
    question:
      'Which female singer, known as the "Queen of Jazz," had popular songs like "Summertime" and "Strange Fruit"?',
    options: [
      "Ella Fitzgerald",
      "Billie Holiday",
      "Nina Simone",
  ...
  {
    question:
      'Who was the "King of Pop" and known for hit albums like "Thriller" and "Bad"?',
  ...
  {
    question:
      'What American folk singer is famous for songs like "Blowin\' in the Wind" and "The Times They Are a-Changin\'"?',
  ...
  {
    question:
      'Which Motown artist, known as the "Prince of Soul," recorded hits like "Ain\'t No Mountain High Enough" and "How Sweet It Is (To Be Loved By You)"?',
    options: [
      "Marvin Gaye",
      "Stevie Wonder",
      "Smokey Robinson",
  ...
  {
    question:
      "In what decade did The Beatles make their debut on The Ed Sullivan Show?",
  ...
  {
    question:
      '"Respect," "Natural Woman," and "Think" are some of the popular songs by which legendary soul singer?',
  ...
  {
    question:
      'Which famous pianist and composer is known for "Moonlight Sonata," "Fur Elise," and "Symphony No. 9"?',
    options: [
      "Ludwig van Beethoven",
      "Wolfgang Amadeus Mozart",
      "Johann Sebastian Bach",
  ...
  {
    question:
      "Who was the lead singer of the band Queen and known for his dynamic stage presence and powerful voice?",
  ...
  {
    question:
      'Which legendary guitarist, often called the "God of Guitar," was known for hits like "Purple Haze" and "Hey Joe"?',
    options: [
      "Jimi Hendrix",
      "Eric Clapton",
      "Jimmy Page",
  ...
  {
    question:
      'What rock band, led by Robert Plant and Jimmy Page, is famous for songs like "Stairway to Heaven" and "Whole Lotta Love"?',
  ...
  {
    question:
      '"Sweet Child o\' Mine" and "November Rain" are hits by which iconic rock band from the 1980s and 1990s?',
  ...
  {
    question:
      'Who won the Eurovision Song Contest in 1974 with the song "Waterloo" and became a global sensation?',
  ...
  {
    question:
      'Which American singer is known as the "Queen of Country" and had hit songs like "Jolene" and "I Will Always Love You"?',
  ...
  {
    question:
      'Who sang the theme song for the James Bond film "Goldfinger" in 1964?',
  ...
  {
    question:
      '"I Will Survive" and "Never Can Say Goodbye" are disco hits by which American singer?',
  ...
  {
    question:
      'In the 1960s, which band released the album "Pet Sounds," which is considered one of the greatest albums of all time?',
  ...
  {
    question:
      'What American singer-songwriter is known for hits like "Fire and Rain" and "You\'ve Got a Friend"?',
  ...
  {
    question:
      "Which classic TV show features a family that includes characters named Fred, Wilma, and Pebbles?",
  ...
  {
    question:
      'Who was the original host of the television game show "Wheel of Fortune"?',
  ...
  {
    question:
      "Which TV series, set in a bar in Boston, featured characters like Sam Malone, Diane Chambers, and Norm Peterson?",
  ...
  {
    question:
      'What was the name of the iconic spaceship commanded by Captain James T. Kirk in the original "Star Trek" series?',
    options: [
      "USS Enterprise",
      "Millennium Falcon",
      "Star Destroyer",
  ...
  {
    question:
      'Who played the role of Archie Bunker in the 1970s sitcom "All in the Family"?',
    options: [
      "Carroll O'Connor",
      "Jackie Gleason",
      "Redd Foxx",
  ...
  {
    question:
      'What medical drama series, set in a fictional hospital called "Seattle Grace," gained widespread popularity during the 2000s?',
  ...
  {
    question:
      'Who starred as J.R. Ewing in the long-running TV series "Dallas"?',
    options: [
      "Larry Hagman",
      "Patrick Duffy",
      "David Hasselhoff",
  ...
  {
    question:
      '"The Golden Girls" featured four elderly women living together in Miami. Can you name all four characters?',
    options: [
      "Dorothy, Rose, Blanche, Sophia",
      "Mary, Rhoda, Phyllis, Sue Ann",
      "Carrie, Samantha, Charlotte, Miranda",
      "Laverne, Shirley, Carmine, Squiggy",
    ],
  ...
  {
    question:
      "What animated TV show follows the life of a yellow, four-fingered family living in the fictional town of Springfield?",
  ...
  {
    question:
      'Who played the role of "Hawkeye" Pierce in the TV series "MAS*H"?',
    options: [
      "Alan Alda",
      "Donald Sutherland",
      "Martin Sheen",
  ...
  {
    question:
      '"The Twilight Zone" was a popular TV series known for its sci-fi and supernatural stories. Who was the show\'s creator?',
    options: [
      "Rod Serling",
      "Alfred Hitchcock",
      "Steven Spielberg",
  ...
  {
    question:
      'In the TV show "Friends," which character was known for saying "How you doin\'?" and had a pet chick named Yasmine?',
    options: [
      "Joey Tribbiani",
      "Chandler Bing",
      "Ross Geller",
  ...
  {
    question:
      "Which TV show featured a high school teacher turned methamphetamine manufacturer named Walter White?",
  ...
  {
    question:
      'Who was the star of the TV show "I Dream of Jeannie," where a genie grants wishes to an astronaut?',
    options: [
      "Barbara Eden",
  ...
  {
    question:
      '"Happy Days" was a popular TV show set in the 1950s. What was the name of the cool and motorcycle-loving character played by Henry Winkler?',
  ...
  {
    question:
      'In the TV series "The Brady Bunch," how many children did Carol and Mike Brady have combined?',
    options: ["6", "8", "4", "10"],
    answer: "6",
    category: "pop culture",
    difficulty: "easy",
  ...
  {
    question:
      'What TV show features a detective named Columbo, who is known for his shabby appearance and the catchphrase "Just one more thing..."?',
  ...
  {
    question:
      'Who hosted the TV talent show "The Ed Sullivan Show," which featured performances by various music artists and entertainers?',
